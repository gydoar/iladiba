				...
				<div class="nine columns left ">
					...
					<div class="row articulo__contenido">
						...
						<div class="twelve columns fechaVisitas">
							<div class="six columns">
								<?php 
								 ...
								 <p>Edición: <?php echo $date->format('F'); ?> - <?php echo $date2->format('F Y'); ?></p> 
						...
						<div class="contenidoArt" id="content">
							...
							<?php echo get_field('parrafo_revista'); ?>
						...
						<div class="paginador">
							<div class="row">
								...
								<?php if ( !empty( $prev_post ) ) : ?>  
									<div class="six columns"><a href="<?php echo get_permalink( $prev_post->ID ); ?>" class="btnPag btnPrev">< Edición Anterior</a>
									</div>
								<?php endif; ?>
								...
								<?php if ( !empty( $next_post ) ) : ?>
									...
									<div class="six columns"><a href="<?php echo get_permalink( $next_post->ID ); ?>" class="btnPag btnNext">Edición Siguiente ></a></div>
